...
const Navbar = () => {
  ...
  return (
    <nav className='w-full flex md:justify-end justify-between items-center p-8 pr-10'>
      ...
      <ul className="text-white font-light md:flex hidden list-none flex-row justify-between flex-initial cursor-pointer pr-10"
          onClick={() => window.open("https://www.tradingview.com/chart/?symbol=ETH", "_blank")}>
            Market
      </ul>
      <ul className="text-white font-light md:flex hidden list-none flex-row justify-between flex-initial cursor-pointer pr-10"
          onClick={() => window.open("https://coinbase.com/", "_blank")}>
            Exchange
      </ul>
      <ul className="text-white font-light md:flex hidden list-none flex-row justify-between flex-initial cursor-pointer pr-10"
          onClick={() => window.open("https://www.youtube.com/watch?v=Wn_Kb3MR_cU", "_blank")}>
            Tutorial
      </ul>
      ...
      <div className="flex relative">
        ...
        {toggleMenu && (
          <ul className="z-10 fixed -top-0 -right-2 p-3 w-[70vw] h-screen shadow-2xl md:hidden list-none flex flex-col justify-start items-end rounded-md purple-glassmorphism text-white animate-slide-in">
            ...
            <li className="text-white cursor-pointer pt-2 pr-10"
              onClick={() => window.open("https://ethereum.org/en/", "_blank")}>
                About
            </li>
            <li className="text-white cursor-pointer pt-2 pr-10"
